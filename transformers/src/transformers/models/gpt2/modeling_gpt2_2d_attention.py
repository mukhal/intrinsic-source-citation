...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        if attention_mask is not None:
            ...
            if len(attention_mask.shape) == 2: # standard mask
            ...
            elif len(attention_mask.shape) == 3: # 3D mask [batch_size, from_seq_length, to_seq_length]
...
class GPT2LMHeadModelWith2DAttention(GPT2PreTrainedModel):
